...
- Usar a skill `run` para validar o fluxo no navegador (golden path e casos de borda: visitante não autenticado, Aluno, Professor, Administrador) e `code-review` antes de finalizar.
